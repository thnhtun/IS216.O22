...
INSERT INTO NHANVIEN (MANV, TENNV, CCCD, GIOITINH, NGAYSINH, DIACHI, LOAINV, TAIKHOAN, MATKHAU, SDT, LUONGCB) 
	VALUES (NhanVien_Seq.NEXTVAL, 'Nguyễn Minh Thái', '098765432101', 'Nam', TO_DATE('1-1-1985', 'DD-MM-YYYY'), '123 Đường ABC, Hà Nội', 'Quản lý', 'quanly01', 'qlpass', '0901256567', 1000000);

INSERT INTO DATABASE_DOAN_NPNT.NHANVIEN (MANV, TENNV, CCCD, GIOITINH, NGAYSINH, DIACHI, LOAINV, TAIKHOAN, MATKHAU, SDT, LUONGCB) 
	VALUES (NhanVien_Seq.NEXTVAL, 'Phạm Ngọc Nhung', '345678901234', 'Nữ', TO_DATE('30-7-1999', 'DD-MM-YYYY'), '101 Đường GHI, Hải Phòng', 'Lễ Tân', 'letan01', 'ltpass', '0930967890', 500000);

INSERT INTO DATABASE_DOAN_NPNT.NHANVIEN (MANV, TENNV, CCCD, GIOITINH, NGAYSINH, DIACHI, LOAINV, TAIKHOAN, MATKHAU, SDT, LUONGCB) 
	VALUES (NhanVien_Seq.NEXTVAL, 'Hoàng Hào Quang', '456789012345', 'Nam', TO_DATE('10-11-1992', 'DD-MM-YYYY'), '202 Đường JKL, Cần Thơ', 'Lễ Tân', 'letan02', 'ltpass', '0943378901', 700000);

INSERT INTO DATABASE_DOAN_NPNT.NHANVIEN (MANV, TENNV, CCCD, GIOITINH, NGAYSINH, DIACHI, LOAINV, TAIKHOAN, MATKHAU, SDT, LUONGCB) 
	VALUES (NhanVien_Seq.NEXTVAL, 'Ngô Nguyễn Tố Như', '567890123456', 'Nữ', TO_DATE('5-2-2000', 'DD-MM-YYYY'), '303 Đường MNO, Huế', 'Lễ Tân', 'letan03', 'ltpass', '0956788112', 650000);
